...
public class BuscaPacinete extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaPacinete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex)tfNome        java.util.logging.Logger.getLogger(BuscaPacinete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
